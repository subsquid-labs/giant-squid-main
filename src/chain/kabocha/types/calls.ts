...
export class BalancesForceTransferCall {
     ...
     * # </weight>
     */
    get asV6(): {source: v6.MultiAddress, dest: v6.MultiAddress, value: bigint} {
        assert(this.isV6)
...
export class BalancesTransferCall {
     ...
     * # </weight>
     */
    get asV6(): {dest: v6.MultiAddress, value: bigint} {
        assert(this.isV6)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferAllCall {
     ...
     *   #</weight>
     */
    get asV6(): {dest: v6.MultiAddress, keepAlive: boolean} {
        assert(this.isV6)
        return this._chain.decodeCall(this.call)
    }
}
