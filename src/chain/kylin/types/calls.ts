...
export class BalancesForceTransferCall {
     ...
     * # </weight>
     */
    get asV21(): {source: v21.MultiAddress, dest: v21.MultiAddress, value: bigint} {
        assert(this.isV21)
...
export class BalancesTransferCall {
     ...
     * # </weight>
     */
    get asV21(): {dest: v21.MultiAddress, value: bigint} {
        assert(this.isV21)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferAllCall {
     ...
     *   #</weight>
     */
    get asV21(): {dest: v21.MultiAddress, keepAlive: boolean} {
        assert(this.isV21)
        return this._chain.decodeCall(this.call)
    }
}
