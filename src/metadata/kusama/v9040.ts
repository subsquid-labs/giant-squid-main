...
export type Event = Event_System | Event_Indices | Event_Balances | Event_Staking | Event_Offences | Event_Session | Event_Grandpa | Event_ImOnline | Event_Democracy | Event_Council | Event_TechnicalCommittee | Event_PhragmenElection | Event_TechnicalMembership | Event_Treasury | Event_Claims | Event_Utility | Event_Identity | Event_Society | Event_Recovery | Event_Vesting | Event_Scheduler | Event_Proxy | Event_Multisig | Event_Bounties | Event_Tips | Event_ElectionProviderMultiPhase | Event_Gilt | Event_ParasInclusion | Event_Paras | Event_ParasUmp | Event_ParasHrmp | Event_Registrar | Event_Slots | Event_Auctions | Event_Crowdloan | Event_XcmPallet
...
export interface Event_ParasUmp {
    __kind: 'ParasUmp'
    value: ParasUmpEvent
}
...
export type ParasUmpEvent = ParasUmpEvent_InvalidFormat | ParasUmpEvent_UnsupportedVersion | ParasUmpEvent_ExecutedUpward | ParasUmpEvent_WeightExhausted | ParasUmpEvent_UpwardMessagesReceived

/**
 *  Upward message is invalid XCM.
 *  \[ id \]
 */
export interface ParasUmpEvent_InvalidFormat {
 ...
 *  \[ id \]
 */
export interface ParasUmpEvent_UnsupportedVersion {
 ...
 *  \[ id, outcome \]
 */
export interface ParasUmpEvent_ExecutedUpward {
 ...
 */
export interface ParasUmpEvent_WeightExhausted {
 ...
 *  \[ para, count, size \]
 */
export interface ParasUmpEvent_UpwardMessagesReceived {
