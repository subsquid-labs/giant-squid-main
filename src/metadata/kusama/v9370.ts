...
export type Type_490 = Type_490_ApplyExtrinsic | Type_490_Finalization | Type_490_Initialization

export interface Type_490_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_490_Finalization {
    __kind: 'Finalization'
}

export interface Type_490_Initialization {
