...
export type SocietyVote = SocietyVote_Skeptic | SocietyVote_Reject | SocietyVote_Approve

export interface SocietyVote_Skeptic {
    __kind: 'Skeptic'
}

export interface SocietyVote_Reject {
    __kind: 'Reject'
}

export interface SocietyVote_Approve {
    __kind: 'Approve'
}
...
export type BalancesEvent = BalancesEvent_NewAccount | BalancesEvent_ReapedAccount | BalancesEvent_Transfer | BalancesEvent_BalanceSet | BalancesEvent_Deposit
