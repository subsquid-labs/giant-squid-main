...
import * as tinkerNodeV1 from './tinkerNodeV1'
...
export class BalancesForceTransferCall {
     ...
     * # </weight>
     */
    get asTinkerNodeV1(): {source: tinkerNodeV1.MultiAddress, dest: tinkerNodeV1.MultiAddress, value: bigint} {
     ...
     * # </weight>
     */
    get asV15(): {source: v15.MultiAddress, dest: v15.MultiAddress, value: bigint} {
        assert(this.isV15)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferCall {
     ...
     * # </weight>
     */
    get asTinkerNodeV1(): {dest: tinkerNodeV1.MultiAddress, value: bigint} {
        assert(this.isTinkerNodeV1)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV15(): {dest: v15.MultiAddress, value: bigint} {
        assert(this.isV15)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferAllCall {
     ...
     *   #</weight>
     */
    get asTinkerNodeV1(): {dest: tinkerNodeV1.MultiAddress, keepAlive: boolean} {
        assert(this.isTinkerNodeV1)
        return this._chain.decodeCall(this.call)
    }
     ...
     *   #</weight>
     */
    get asV15(): {dest: v15.MultiAddress, keepAlive: boolean} {
        assert(this.isV15)
        return this._chain.decodeCall(this.call)
    }
}
