...
export class BalancesForceTransferCall {
     ...
     * # </weight>
     */
    get asV172(): {source: v172.MultiAddress, dest: v172.MultiAddress, value: bigint} {
        assert(this.isV172)
...
export class BalancesTransferCall {
     ...
     * # </weight>
     */
    get asV172(): {dest: v172.MultiAddress, value: bigint} {
        assert(this.isV172)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferAllCall {
     ...
     *   #</weight>
     */
    get asV172(): {dest: v172.MultiAddress, keepAlive: boolean} {
        assert(this.isV172)
        return this._chain.decodeCall(this.call)
    }
}
