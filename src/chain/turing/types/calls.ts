...
export class BalancesForceTransferCall {
     ...
     * # </weight>
     */
    get asV277(): {source: v277.MultiAddress, dest: v277.MultiAddress, value: bigint} {
        assert(this.isV277)
...
export class BalancesTransferCall {
     ...
     * # </weight>
     */
    get asV277(): {dest: v277.MultiAddress, value: bigint} {
        assert(this.isV277)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferAllCall {
     ...
     *   #</weight>
     */
    get asV277(): {dest: v277.MultiAddress, keepAlive: boolean} {
        assert(this.isV277)
        return this._chain.decodeCall(this.call)
    }
}
