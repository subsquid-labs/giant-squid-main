...
export type StakingEvent = StakingEvent_EraPayout | StakingEvent_Reward | StakingEvent_Slash | StakingEvent_OldSlashingReportDiscarded | StakingEvent_StakingElection | StakingEvent_Bonded | StakingEvent_Unbonded | StakingEvent_Withdrawn
...
export type SchedulerEvent = SchedulerEvent_Scheduled | SchedulerEvent_Dispatched
