...
export interface ActiveGiltsTotal {
    frozen: bigint
    proportion: bigint
    index: number
    target: bigint
...
export type CoreOccupied = CoreOccupied_Parathread | CoreOccupied_Parachain

export interface CoreOccupied_Parathread {
    __kind: 'Parathread'
    value: ParathreadEntry
}

export interface CoreOccupied_Parachain {
    __kind: 'Parachain'
}
...
export type ParaLifecycle = ParaLifecycle_Onboarding | ParaLifecycle_Parathread | ParaLifecycle_Parachain | ParaLifecycle_UpgradingToParachain | ParaLifecycle_DowngradingToParathread | ParaLifecycle_OutgoingParathread | ParaLifecycle_OutgoingParachain
...
export interface ParaLifecycle_UpgradingToParachain {
    __kind: 'UpgradingToParachain'
}

export interface ParaLifecycle_DowngradingToParathread {
    __kind: 'DowngradingToParathread'
}

export interface ParaLifecycle_OutgoingParathread {
    __kind: 'OutgoingParathread'
}

export interface ParaLifecycle_OutgoingParachain {
    __kind: 'OutgoingParachain'
}
...
export type Event = Event_System | Event_Indices | Event_Balances | Event_Staking | Event_Offences | Event_Session | Event_Grandpa | Event_ImOnline | Event_Democracy | Event_Council | Event_TechnicalCommittee | Event_PhragmenElection | Event_TechnicalMembership | Event_Treasury | Event_Claims | Event_Utility | Event_Identity | Event_Society | Event_Recovery | Event_Vesting | Event_Scheduler | Event_Proxy | Event_Multisig | Event_Bounties | Event_Tips | Event_ElectionProviderMultiPhase | Event_Gilt | Event_ParasInclusion | Event_Paras | Event_ParasHrmp | Event_Registrar | Event_Slots | Event_Auctions | Event_Crowdloan | Event_XcmPallet
...
export interface Event_ParasInclusion {
    __kind: 'ParasInclusion'
    value: ParasInclusionEvent
}
...
export interface Event_ParasHrmp {
    __kind: 'ParasHrmp'
    value: ParasHrmpEvent
}
...
export type StakingEvent = StakingEvent_EraPayout | StakingEvent_Reward | StakingEvent_Slash | StakingEvent_OldSlashingReportDiscarded | StakingEvent_StakingElection | StakingEvent_Bonded | StakingEvent_Unbonded | StakingEvent_Withdrawn | StakingEvent_Kicked
...
export type ParasInclusionEvent = ParasInclusionEvent_CandidateBacked | ParasInclusionEvent_CandidateIncluded | ParasInclusionEvent_CandidateTimedOut

/**
 *  A candidate was backed. [candidate, head_data]
 */
export interface ParasInclusionEvent_CandidateBacked {
 ...
 */
export interface ParasInclusionEvent_CandidateIncluded {
 ...
 */
export interface ParasInclusionEvent_CandidateTimedOut {
...
export type ParasHrmpEvent = ParasHrmpEvent_OpenChannelRequested | ParasHrmpEvent_OpenChannelAccepted | ParasHrmpEvent_ChannelClosed

/**
 *  Open HRMP channel requested.
 *  \[sender, recipient, proposed_max_capacity, proposed_max_message_size\]
 */
export interface ParasHrmpEvent_OpenChannelRequested {
 ...
 */
export interface ParasHrmpEvent_OpenChannelAccepted {
 ...
 */
export interface ParasHrmpEvent_ChannelClosed {
...
export type AuctionsEvent = AuctionsEvent_AuctionStarted | AuctionsEvent_AuctionClosed | AuctionsEvent_WonDeploy | AuctionsEvent_WonRenewal | AuctionsEvent_Reserved | AuctionsEvent_Unreserved | AuctionsEvent_ReserveConfiscated | AuctionsEvent_BidAccepted | AuctionsEvent_WinningOffset
 ...
 */
export interface AuctionsEvent_WonDeploy {
    __kind: 'WonDeploy'
    value: [Uint8Array, SlotRange, number, bigint]
}
 ...
 */
export interface AuctionsEvent_WonRenewal {
    __kind: 'WonRenewal'
...
export type CrowdloanEvent = CrowdloanEvent_Created | CrowdloanEvent_Contributed | CrowdloanEvent_Withdrew | CrowdloanEvent_PartiallyRefunded | CrowdloanEvent_AllRefunded | CrowdloanEvent_Dissolved | CrowdloanEvent_DeployDataFixed | CrowdloanEvent_Onboarded | CrowdloanEvent_HandleBidResult | CrowdloanEvent_Edited | CrowdloanEvent_MemoUpdated | CrowdloanEvent_AddedToNewRaise
 ...
 */
export interface CrowdloanEvent_DeployDataFixed {
    __kind: 'DeployDataFixed'
    value: number
}
 ...
 */
export interface CrowdloanEvent_Onboarded {
    __kind: 'Onboarded'
    value: [number, number]
}
