...
export type Type_632 = Type_632_Ongoing | Type_632_Approved | Type_632_Rejected | Type_632_Cancelled | Type_632_TimedOut | Type_632_Killed

export interface Type_632_Ongoing {
    __kind: 'Ongoing'
    value: Type_633
}

export interface Type_632_Approved {
    __kind: 'Approved'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_632_Rejected {
    __kind: 'Rejected'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_632_Cancelled {
    __kind: 'Cancelled'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_632_TimedOut {
    __kind: 'TimedOut'
    value: [number, (Deposit | undefined), (Deposit | undefined)]
}

export interface Type_632_Killed {
    __kind: 'Killed'
    value: number
}
