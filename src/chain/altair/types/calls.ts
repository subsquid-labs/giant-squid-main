...
export class BalancesForceTransferCall {
     ...
     *  # </weight>
     */
    get asV1003(): {source: v1003.LookupSource, dest: v1003.LookupSource, value: bigint} {
        assert(this.isV1003)
     ...
     * # </weight>
     */
    get asV1006(): {source: v1006.MultiAddress, dest: v1006.MultiAddress, value: bigint} {
        assert(this.isV1006)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferCall {
     ...
     *  # </weight>
     */
    get asV1003(): {dest: v1003.LookupSource, value: bigint} {
        assert(this.isV1003)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV1006(): {dest: v1006.MultiAddress, value: bigint} {
        assert(this.isV1006)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferAllCall {
     ...
     *    #</weight>
     */
    get asV1003(): {dest: v1003.LookupSource, keepAlive: boolean} {
        assert(this.isV1003)
        return this._chain.decodeCall(this.call)
    }
     ...
     *   #</weight>
     */
    get asV1006(): {dest: v1006.MultiAddress, keepAlive: boolean} {
        assert(this.isV1006)
        return this._chain.decodeCall(this.call)
    }
}
