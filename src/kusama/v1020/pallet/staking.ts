...
import {OnSessionEnding} from './session'
...
export function newSession<T extends Config>(
    this: Pallet<T, {Storage: Pick<Storage<T>, 'ForceEra' | 'CurrentEraStartSessionIndex' | 'CurrentEra'>}>,
...
export function newEra<T extends Config>(
    this: Pallet<T, {Storage: Pick<Storage<T>, 'CurrentEra'>}>,
    ctx: MappingContext<StoreWithCache>,
    block: BlockHeader,
