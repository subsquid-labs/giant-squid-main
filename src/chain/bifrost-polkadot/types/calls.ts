...
export class BalancesForceTransferCall {
     ...
     * # </weight>
     */
    get asV932(): {source: v932.MultiAddress, dest: v932.MultiAddress, value: bigint} {
        assert(this.isV932)
...
export class BalancesTransferCall {
     ...
     * # </weight>
     */
    get asV932(): {dest: v932.MultiAddress, value: bigint} {
        assert(this.isV932)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferAllCall {
     ...
     *   #</weight>
     */
    get asV932(): {dest: v932.MultiAddress, keepAlive: boolean} {
        assert(this.isV932)
        return this._chain.decodeCall(this.call)
    }
}
