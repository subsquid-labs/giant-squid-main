...
export class BalancesForceTransferCall {
     ...
     * # </weight>
     */
    get asV14(): {source: v14.MultiAddress, dest: v14.MultiAddress, value: bigint} {
        assert(this.isV14)
...
export class BalancesTransferCall {
     ...
     * # </weight>
     */
    get asV14(): {dest: v14.MultiAddress, value: bigint} {
        assert(this.isV14)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferAllCall {
     ...
     *   #</weight>
     */
    get asV14(): {dest: v14.MultiAddress, keepAlive: boolean} {
        assert(this.isV14)
        return this._chain.decodeCall(this.call)
    }
}
