...
export class BalancesForceTransferCall {
     ...
     * # </weight>
     */
    get asV1000(): {source: v1000.MultiAddress, dest: v1000.MultiAddress, value: bigint} {
        assert(this.isV1000)
...
export class BalancesTransferCall {
     ...
     * # </weight>
     */
    get asV1000(): {dest: v1000.MultiAddress, value: bigint} {
        assert(this.isV1000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferAllCall {
     ...
     *   #</weight>
     */
    get asV1000(): {dest: v1000.MultiAddress, keepAlive: boolean} {
        assert(this.isV1000)
        return this._chain.decodeCall(this.call)
    }
}
