...
export class BalancesForceTransferCall {
     ...
     *  # </weight>
     */
    get asV21(): {source: v21.LookupSource, dest: v21.LookupSource, value: bigint} {
        assert(this.isV21)
     ...
     * # </weight>
     */
    get asV2800(): {source: v2800.MultiAddress, dest: v2800.MultiAddress, value: bigint} {
        assert(this.isV2800)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferCall {
     ...
     *  # </weight>
     */
    get asV21(): {dest: v21.LookupSource, value: bigint} {
        assert(this.isV21)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV2800(): {dest: v2800.MultiAddress, value: bigint} {
        assert(this.isV2800)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferAllCall {
     ...
     *    #</weight>
     */
    get asV21(): {dest: v21.LookupSource, keepAlive: boolean} {
        assert(this.isV21)
        return this._chain.decodeCall(this.call)
    }
     ...
     *   #</weight>
     */
    get asV2800(): {dest: v2800.MultiAddress, keepAlive: boolean} {
        assert(this.isV2800)
        return this._chain.decodeCall(this.call)
    }
}
