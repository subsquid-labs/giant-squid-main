...
export class BalancesForceTransferCall {
     ...
     * # </weight>
     */
    get asV200(): {source: v200.MultiAddress, dest: v200.MultiAddress, value: bigint} {
        assert(this.isV200)
...
export class BalancesTransferCall {
     ...
     * # </weight>
     */
    get asV200(): {dest: v200.MultiAddress, value: bigint} {
        assert(this.isV200)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferAllCall {
     ...
     *   #</weight>
     */
    get asV200(): {dest: v200.MultiAddress, keepAlive: boolean} {
        assert(this.isV200)
        return this._chain.decodeCall(this.call)
    }
}
