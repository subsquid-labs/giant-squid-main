...
export interface ReceiptRecord {
    proportion: bigint
    owner: ([Uint8Array, bigint] | undefined)
    expiry: number
}
...
export type Type_498 = Type_498_ApplyExtrinsic | Type_498_Finalization | Type_498_Initialization

export interface Type_498_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_498_Finalization {
    __kind: 'Finalization'
}

export interface Type_498_Initialization {
...
export type Type_61 = Type_61_Ok | Type_61_Err

export interface Type_61_Ok {
    __kind: 'Ok'
}

export interface Type_61_Err {
    __kind: 'Err'
    value: DispatchError
}
