...
import * as v917004 from './v917004'
...
export class BalancesForceTransferCall {
     ...
     * # </weight>
     */
    get asV917004(): {source: v917004.MultiAddress, dest: v917004.MultiAddress, value: bigint} {
        assert(this.isV917004)
...
export class BalancesTransferCall {
     ...
     * # </weight>
     */
    get asV917004(): {dest: v917004.MultiAddress, value: bigint} {
        assert(this.isV917004)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferAllCall {
     ...
     *   #</weight>
     */
    get asV917004(): {dest: v917004.MultiAddress, keepAlive: boolean} {
        assert(this.isV917004)
        return this._chain.decodeCall(this.call)
    }
}
