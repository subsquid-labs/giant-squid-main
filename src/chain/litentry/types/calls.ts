...
export class BalancesForceTransferCall {
     ...
     * # </weight>
     */
    get asV9000(): {source: v9000.MultiAddress, dest: v9000.MultiAddress, value: bigint} {
        assert(this.isV9000)
...
export class BalancesTransferCall {
     ...
     * # </weight>
     */
    get asV9000(): {dest: v9000.MultiAddress, value: bigint} {
        assert(this.isV9000)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferAllCall {
     ...
     *   #</weight>
     */
    get asV9000(): {dest: v9000.MultiAddress, keepAlive: boolean} {
        assert(this.isV9000)
        return this._chain.decodeCall(this.call)
    }
}
