...
export interface Event_DummySlots {
    __kind: 'DummySlots'
    value: DummySlotsEvent
}

export interface Event_DummyRegistrar {
    __kind: 'DummyRegistrar'
    value: DummyRegistrarEvent
}
...
export type DummySlotsEvent = DummySlotsEvent_Dummy

export interface DummySlotsEvent_Dummy {
    __kind: 'Dummy'
    value: Uint8Array
}

export type DummyRegistrarEvent = DummyRegistrarEvent_Dummy

export interface DummyRegistrarEvent_Dummy {
    __kind: 'Dummy'
    value: Uint8Array
}
