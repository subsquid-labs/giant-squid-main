...
export class BalancesForceTransferCall {
     ...
     * # </weight>
     */
    get asV9020(): {source: v9020.MultiAddress, dest: v9020.MultiAddress, value: bigint} {
        assert(this.isV9020)
...
export class BalancesTransferCall {
     ...
     * # </weight>
     */
    get asV9020(): {dest: v9020.MultiAddress, value: bigint} {
        assert(this.isV9020)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferAllCall {
     ...
     *   #</weight>
     */
    get asV9020(): {dest: v9020.MultiAddress, keepAlive: boolean} {
        assert(this.isV9020)
        return this._chain.decodeCall(this.call)
    }
}
