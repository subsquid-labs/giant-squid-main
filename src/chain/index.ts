...
function getChain(): {
    ...
    const chainName = assertNotNull(process.env.CHAIN, 'Missing env variable CHAIN')
    ...
    let processorConfig: ProcessorConfig = {
        ...
        dataSource: {
            archive: lookupArchive(chainConfig.archiveName as KnownArchivesSubstrate, {release: 'FireSquid'}),
        },
