...
export class BalancesForceTransferCall {
     ...
     * # </weight>
     */
    get asV601(): {source: v601.MultiAddress, dest: v601.MultiAddress, value: bigint} {
        assert(this.isV601)
...
export class BalancesTransferCall {
     ...
     * # </weight>
     */
    get asV601(): {dest: v601.MultiAddress, value: bigint} {
        assert(this.isV601)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferAllCall {
     ...
     *   #</weight>
     */
    get asV601(): {dest: v601.MultiAddress, keepAlive: boolean} {
        assert(this.isV601)
        return this._chain.decodeCall(this.call)
    }
}
