...
export class BalancesForceTransferCall {
     ...
     * # </weight>
     */
    get asV1008(): {source: v1008.MultiAddress, dest: v1008.MultiAddress, value: bigint} {
        assert(this.isV1008)
...
export class BalancesTransferCall {
     ...
     * # </weight>
     */
    get asV1008(): {dest: v1008.MultiAddress, value: bigint} {
        assert(this.isV1008)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferAllCall {
     ...
     *   #</weight>
     */
    get asV1008(): {dest: v1008.MultiAddress, keepAlive: boolean} {
        assert(this.isV1008)
        return this._chain.decodeCall(this.call)
    }
}
