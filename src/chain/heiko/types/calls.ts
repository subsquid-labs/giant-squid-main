...
export class BalancesForceTransferCall {
     ...
     *  # </weight>
     */
    get asV160(): {source: v160.LookupSource, dest: v160.LookupSource, value: bigint} {
        assert(this.isV160)
     ...
     * # </weight>
     */
    get asV171(): {source: v171.MultiAddress, dest: v171.MultiAddress, value: bigint} {
        assert(this.isV171)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferCall {
     ...
     *  # </weight>
     */
    get asV160(): {dest: v160.LookupSource, value: bigint} {
        assert(this.isV160)
        return this._chain.decodeCall(this.call)
    }
     ...
     * # </weight>
     */
    get asV171(): {dest: v171.MultiAddress, value: bigint} {
        assert(this.isV171)
        return this._chain.decodeCall(this.call)
    }
}
...
export class BalancesTransferAllCall {
     ...
     *    #</weight>
     */
    get asV160(): {dest: v160.LookupSource, keepAlive: boolean} {
        assert(this.isV160)
        return this._chain.decodeCall(this.call)
    }
     ...
     *   #</weight>
     */
    get asV171(): {dest: v171.MultiAddress, keepAlive: boolean} {
        assert(this.isV171)
        return this._chain.decodeCall(this.call)
    }
}
