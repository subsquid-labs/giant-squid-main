...
export type UpgradeRestriction = UpgradeRestriction_Present

export interface UpgradeRestriction_Present {
    __kind: 'Present'
}
...
export type UmpEvent = UmpEvent_InvalidFormat | UmpEvent_UnsupportedVersion | UmpEvent_ExecutedUpward | UmpEvent_WeightExhausted | UmpEvent_UpwardMessagesReceived
...
export type HrmpEvent = HrmpEvent_OpenChannelRequested | HrmpEvent_OpenChannelAccepted | HrmpEvent_ChannelClosed
